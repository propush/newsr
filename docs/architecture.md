...
- `cache/newsr-llm.log`: request log for LLM calls, brief-generation stage metadata, repair retry metadata, and non-provider network request metadata such as DuckDuckGo search URLs, methods, statuses, and errors

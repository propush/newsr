...
from .urls import HYPERALLERGIC_ROOT, normalize_target_path


class HyperallergicProvider:
    provider_id = "hyperallergic"
    display_name = "Hyperallergic"
    ...
    def fetch_candidates(
        ...
        target_path = normalize_target_path(target.payload.get("path", f"/tag/{target.target_key}/"))
        html = self._read_url(f"{HYPERALLERGIC_ROOT}{target_path}", cancellation)

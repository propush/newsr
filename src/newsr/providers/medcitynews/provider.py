...
from .urls import MEDCITYNEWS_ROOT, normalize_target_path


class MedCityNewsProvider:
    ...
    def fetch_candidates(
        ...
        target_path = normalize_target_path(target.payload.get("path", f"/category/channel/{target.target_key}/"))
        html = self._read_url(f"{MEDCITYNEWS_ROOT}{target_path}", cancellation)

...
_MESSAGES: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "provider_group.virtual": "Virtual",
        "provider_group.providers": "Providers",
        "provider_group.topics": "Topics",
        ...
        "source.hint": "Space: toggle   U: edit schedule   X: delete topic   A: apply",
        ...
        "source.status.counts": "Loaded {providers} providers. Enabled {enabled}. Selected {selected} targets globally.",
        ...
        "brief.status.refresh_busy": "Brief review is unavailable while refresh is running.",
        "brief.status.selecting_articles": "selecting articles",
        "brief.status.marking_read": "marking selected sources read",
        "brief.status.compressing_summaries": "compressing summaries {index} of {total}",
        "brief.status.reducing_notes": "reducing notes pass {pass_number}",
        "brief.status.writing_final": "writing final brief",
        "brief.status.repairing_compressed": (
            "repairing compressed summary batch {batch_index} of {batch_count}, attempt {attempt} of {attempts}"
        ),
        "brief.status.compressed_fallback": "using fallback for compressed summary batch {batch_index} of {batch_count}",
        "brief.status.repairing_final": "repairing final brief, attempt {attempt} of {attempts}",
        "brief.status.final_fallback": "using fallback for final brief",
        ...
        "brief_reader.hint_with_jump": "Type number + Enter: open article   Esc: close   Up/Down: scroll",
        "brief_jump.binding.jump": "Jump",
        "brief_jump.binding.cancel": "Cancel",
        "brief_jump.header": "Jump to Article",
        "brief_jump.body": "Enter article number from 1 to {max_number}.",
        "brief_jump.button.jump": "Jump",
        "brief_jump.button.cancel": "Cancel",
        "brief_jump.error.empty": "Enter an article number.",
        "brief_jump.error.number": "Use digits only.",
        "brief_jump.error.range": "Choose a number from 1 to {max_number}.",
        "brief_jump.status.not_found": "brief article is no longer available",
    ...
    "ru": {
        ...
        "provider_group.virtual": "Виртуальные",
        "provider_group.providers": "Провайдеры",
        "provider_group.topics": "Темы",
        ...
        "source.hint": "Space: переключить   U: расписание   X: удалить тему   A: применить",
        ...
        "source.status.counts": "Загружено провайдеров: {providers}. Включено: {enabled}. Всего выбрано целей: {selected}.",
        ...
        "brief.status.refresh_busy": "Краткий обзор недоступен во время обновления.",
        "brief.status.selecting_articles": "выбор статей",
        "brief.status.marking_read": "выбранные источники отмечаются прочитанными",
        "brief.status.compressing_summaries": "сжатие сводок {index} из {total}",
        "brief.status.reducing_notes": "сокращение заметок, проход {pass_number}",
        "brief.status.writing_final": "написание итогового обзора",
        "brief.status.repairing_compressed": (
            "исправление сжатой сводки, пакет {batch_index} из {batch_count}, попытка {attempt} из {attempts}"
        ),
        "brief.status.compressed_fallback": "резервная сжатая сводка для пакета {batch_index} из {batch_count}",
        "brief.status.repairing_final": "исправление итогового обзора, попытка {attempt} из {attempts}",
        "brief.status.final_fallback": "использование резервного итогового обзора",
        ...
        "brief_reader.hint_with_jump": "Номер + Enter: открыть статью   Esc: закрыть   Up/Down: прокрутка",
        "brief_jump.binding.jump": "Перейти",
        "brief_jump.binding.cancel": "Отмена",
        "brief_jump.header": "Переход к статье",
        "brief_jump.body": "Введите номер статьи от 1 до {max_number}.",
        "brief_jump.button.jump": "Перейти",
        "brief_jump.button.cancel": "Отмена",
        "brief_jump.error.empty": "Введите номер статьи.",
        "brief_jump.error.number": "Используйте только цифры.",
        "brief_jump.error.range": "Выберите номер от 1 до {max_number}.",
        "brief_jump.status.not_found": "статья из обзора больше недоступна",
...
class UILocalizer:
    _STATUS_PATTERNS: Final[tuple[tuple[re.Pattern[str], str], ...]] = (
        ...
        (
            re.compile(
                r"^Loaded (?P<providers>\d+) providers\. Enabled (?P<enabled>\d+)\. Selected (?P<selected>\d+) targets globally\.$"
            ),
